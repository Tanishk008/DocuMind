...
const SEED_PROMPT = ChatPromptTemplate.fromTemplate(`
 ...
 */
export function consolidateGraphs(
...
export function retrieveSubGraph(
  ...
  const retrievedEdges = new Set<GraphEdge>()
 ...
 */
export function formatGraphAsText(graph: { nodes: GraphNode[]; edges: GraphEdge[] }): string {
